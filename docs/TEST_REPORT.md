...
現在はP3のホーム・基本説明・試合選択導線、説明1/3の照準確認、2/3の指を離す確認、3/3の充電輪待機確認、30秒の試し撃ち、HTML結果画面、3盤面の試作、れんしゅう／ふつうCPU、両砲台の状態表示、同条件再戦、効果音・音楽の個別設定とWeb Audio合成音、音設定の端末内保存・破損時の無音復旧、試遊記録の端末内保存・コピー本文の生成、基本説明の完了状態保存、2点コアの予告・出現・得点を自動検査した段階です。試合選択では3盤面、れんしゅう／ふつうCPU、30秒の試し撃ちまたは90秒試合を開始可能としています。ホーム、説明、試合選択中はPhaserを生成せず、試合へ入った後に時計を開始します。自動検査は通過しましたが、iPhone実機、初見試遊、CPUの勝率調整、独立レビュー、J-PlatPatの確定検索はまだ完了していません。無得点時間によるゴール拡大と中央波は次のP3単位に残しています。未確認の項目を「通過」とは記録しません。
...
| 単体試験                     | 通過 | `vitest run`、2026-08-16、11ファイル・84件                                                            |
| 本番出力                     | 通過 | `vite build`、2026-08-16、`dist`生成。gzip JavaScriptは372.38KB                                       |
...
自動検査が通っても、P3のすべての通過条件を満たしたことにはしない。実機、初見試遊、CPUの勝率・公平性、権利確認、独立レビューは別の証拠として追記する。
